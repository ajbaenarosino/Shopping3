...
/// Array of day names
const char * const DAYNAME [] = {"SUNDAY", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY"}; // Change: Set MONDAY as first day of the week instead of SUNDAY
...
public:
    ...
    /**
     * @brief It gives the Date but with hour, min and sec set to 0
     * @return string that contains dataTime, including the tailing UTC, but with time 00:00:00
     */
    std::string NonHourDate() const;
};
