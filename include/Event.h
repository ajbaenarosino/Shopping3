...
const std::string VALID_FIELDS[] = {"DateTime", "Type", "ProductID", "CategoryID", "CategoryCode", "Brand", "Price", "UserID", "Session"};
...
public:
     ...
     */
    void setDateTime(std::string const &Datetime);
    /**
     ...
     * @param session
     */
    void setSession(std::string const &session);
    /**
